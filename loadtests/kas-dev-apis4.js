...
export const options = {
  stages: [
    { duration: "720s", target: 500 },
    { duration: "2160s", target: 500 },
    { duration: "720s", target: 0 }
  ],
  ext: {
    loadimpact: {
      distribution: {
        "Seoul - KR": { loadZone: "amazon:kr:seoul", percent: 50 },
        "Tokyo - JP": { loadZone: "amazon:jp:tokyo", percent: 50 }
      }
    }
  }
};
